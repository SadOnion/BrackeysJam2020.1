...
public class MouseSkill : MonoBehaviour
{
    ...
    private AnimationController boyAnimationController;
    private AnimationController girlAnimationController;
    ...
    {
        if(girlAnimationController == null) girlAnimationController = CharacterSwitchHandler.newTarget.gameObject.GetComponent<AnimationController>();
        girlAnimationController.UsePowerAnimation();
        Vector2 mousePos = GetWorldPositionOnPlane(Input.mousePosition, 0);
    ...
    {
         if(boyAnimationController == null) boyAnimationController = CharacterSwitchHandler.newTarget.gameObject.GetComponent<AnimationController>();
        boyAnimationController.UsePowerAnimation();
